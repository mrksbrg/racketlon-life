...
describe("age wired into the actual systems (not just the pure curve functions)", () => {
  it("an older player's match effective strength is lower at identical skill", () => {
    ...
    const young = { id: "a", name: "a", skills, formBySport, fatigue: 0, stamina: 0.5, age: 26 };
    const old = { id: "a", name: "a", skills, formBySport, fatigue: 0, stamina: 0.5, age: 70 };
    const opponent = { id: "b", name: "b", skills, formBySport, fatigue: 0, stamina: 0.5, age: 26 };
