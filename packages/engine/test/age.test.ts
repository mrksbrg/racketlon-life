...
describe("age wired into the actual systems (not just the pure curve functions)", () => {
  it("an older player's match effective strength is lower at identical skill", () => {
    ...
    const young = { id: "a", name: "a", nationality: "SWE", gender: "m" as const, skills, formBySport, fatigue: 0, endurance: 0.5, composure: 0.5, clutch: 0.5, age: 26, durability: 0.5, coreStrength: 0.5 };
    const old = { id: "a", name: "a", nationality: "SWE", gender: "m" as const, skills, formBySport, fatigue: 0, endurance: 0.5, composure: 0.5, clutch: 0.5, age: 70, durability: 0.5, coreStrength: 0.5 };
    const opponent = { id: "b", name: "b", nationality: "SWE", gender: "m" as const, skills, formBySport, fatigue: 0, endurance: 0.5, composure: 0.5, clutch: 0.5, age: 26, durability: 0.5, coreStrength: 0.5 };
