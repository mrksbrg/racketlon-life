...
describe("age wired into the actual systems (not just the pure curve functions)", () => {
  it("an older player's match effective strength is lower at identical skill", () => {
    ...
    const young = { id: "a", name: "a", skills, form: 0, fatigue: 0, age: 26 };
    const old = { id: "a", name: "a", skills, form: 0, fatigue: 0, age: 70 };
    const opponent = { id: "b", name: "b", skills, form: 0, fatigue: 0, age: 26 };
