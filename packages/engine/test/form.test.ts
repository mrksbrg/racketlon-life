...
describe("per-sport form (training readiness)", () => {
  ...
  it("gives the well-in-form player a higher point-win probability at identical skill", () => {
    ...
    const sharp = { id: "a", name: "a", skills, formBySport: { tt: 20, bd: 20, sq: 20, tn: 20 }, fatigue: 0, stamina: 0.5, composure: 0.5, clutch: 0.5, age: 25 };
    const rusty = { id: "a", name: "a", skills, formBySport: { tt: 0, bd: 0, sq: 0, tn: 0 }, fatigue: 0, stamina: 0.5, composure: 0.5, clutch: 0.5, age: 25 };
    const opponent = { id: "b", name: "b", skills, formBySport: { tt: 20, bd: 20, sq: 20, tn: 20 }, fatigue: 0, stamina: 0.5, composure: 0.5, clutch: 0.5, age: 25 };
