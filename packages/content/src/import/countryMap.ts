 ...
 * the current dataset (58). The UK constituent nations (ENG/SCO/NIR/WAL) all
...
const IOC_TO_ISO2: Record<string, string> = {
  ...
  CAN: "CA", CHN: "CN", CRO: "HR", CUB: "CU", CZE: "CZ", DEN: "DK", EGY: "EG",
  ENG: "GB", ERI: "ER", ESP: "ES", EST: "EE", FIN: "FI", FRA: "FR", GBR: "GB",
  GER: "DE", GRE: "GR", HKG: "HK", HUN: "HU", INA: "ID", IND: "IN", IRL: "IE",
  ISR: "IL", ITA: "IT", JOR: "JO", JPN: "JP", KOR: "KR", LAT: "LV", MAR: "MA",
  MLT: "MT", NED: "NL", NIR: "GB", NOR: "NO", NZL: "NZ", PER: "PE", PNG: "PG",
  POL: "PL", ROM: "RO", RSA: "ZA", RUS: "RU", SCO: "GB", SIN: "SG", SLO: "SI",
  SUI: "CH", SVK: "SK", SWE: "SE", THA: "TH", TJK: "TJ", TUR: "TR", UKR: "UA",
  USA: "US", WAL: "GB",
};
