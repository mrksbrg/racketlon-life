...
next week, visibly. Gym/cardio build physical attributes (core strength/stamina) rather than racket-sport skills; those body attributes also drift down when ignored and erode slowly with age.
