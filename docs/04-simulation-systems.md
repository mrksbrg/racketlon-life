...
next week, visibly. Gym/cardio build physical attributes (core strength/stamina) rather than racket-sport skills; squash and, to a smaller extent, badminton also carry over into stamina because they are physically demanding. Body-attribute gains taper near the hidden 0..1 ceiling, and those attributes drift down when ignored and erode slowly with age.
